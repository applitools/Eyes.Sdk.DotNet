namespace Applitools.Utils
{
    ...
    public static class SeleniumUtils
    {
        ...
        public static readonly bool RUN_HEADLESS = false;//"true".Equals(Environment.GetEnvironmentVariable("APPLITOOLS_RUN_HEADLESS"), StringComparison.OrdinalIgnoreCase);
        ...
        public static IWebDriver CreateWebDriver(DriverOptions options)
        {
            ...
            try
            {
                ...
                {
                    case "firefox": webDriver = DRIVER_PATH != null ? new FirefoxDriver(DRIVER_PATH, (FirefoxOptions)options) : new FirefoxDriver((FirefoxOptions)options); break;
                    case "safari": webDriver = DRIVER_PATH != null ? new SafariDriver(DRIVER_PATH, (SafariOptions)options) : new SafariDriver((SafariOptions)options); break;
                    case "internet explorer": webDriver = DRIVER_PATH != null ? new InternetExplorerDriver(DRIVER_PATH, (InternetExplorerOptions)options) : new InternetExplorerDriver((InternetExplorerOptions)options); break;
                    case "edge": webDriver = DRIVER_PATH != null ? new EdgeDriver(DRIVER_PATH, (EdgeOptions)options) : new EdgeDriver((EdgeOptions)options); break;
                    default: webDriver = CreateChromeDriver((ChromeOptions)options); break;
                }
            }
            catch (Exception)
            {
